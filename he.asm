; Filename: handsonexam2.asm
; Name: Ethan Benedict M. Labajo
; Date: September 26, 2025
; FISHBOOK Account Registration with background color choices
...
.data
    ...
    ; BG Color Choice
    bgp db "How do you like to display the summary table?$"
    bg1 db "1 - blue background$"
    bg2 db "2 - red background$"

    bgpc db "Enter your choice: $"
